...
public class DiagnosisStatisticsBean {
	...
	Date endDate;
	/** top one cause of death */
	String topOneCauseOfDeath;
	/** top two cause of death */
	String topTwoCauseOfDeath;

	/**
	 * Constructor accept causes of death
	 * @param cause1 top 1 cause
	 * @param cause2 top 2 cause
	 * @param startDate The beginning of the data's time period
	 * @param endDate The end of the data's time period
	 */
	public DiagnosisStatisticsBean(String cause1, String cause2, Date startDate, Date endDate) {
		this.startDate = (Date) startDate.clone();
		this.endDate = (Date) endDate.clone();
		this.topOneCauseOfDeath = cause1;
		this.topTwoCauseOfDeath = cause2;
	}
	...
	/**
	 * getter for top one cause of death
	 * @return a cause
	 */
	public String getTopOneCauseOfDeath() { return topOneCauseOfDeath; }

	/**
	 * getter for top two cause of death
	 * @return a cause
	 */
	public String getTopTwoCauseOfDeath() { return topTwoCauseOfDeath; }
