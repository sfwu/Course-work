...
public class SetPatientHCPTest {
    ...
    @Test
    public void setPatientHCPTest() throws DBException{
        try {
            patientDAO.setPatientHCP(1234L, 900000000L);
