...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception {
		...
		Select role = new Select(wd.findElement(By.name("role")));
		role.selectByVisibleText("Patient");
		...
		WebElement answer = wd.findElement(By.name("answer"));
		answer.sendKeys("blue");

		WebElement pass = wd.findElement(By.name("password"));
		pass.sendKeys("newPw12345");

		WebElement confPass = wd.findElement(By.name("confirmPassword"));
		confPass.sendKeys("newPw12345");
		confPass.submit();
