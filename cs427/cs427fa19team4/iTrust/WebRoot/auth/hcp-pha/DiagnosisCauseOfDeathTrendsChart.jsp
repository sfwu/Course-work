...
<jsp:useBean id="DSchart1" class="edu.ncsu.csc.itrust.charts.DiagnosisTrendData"/>
...
if ( view.equalsIgnoreCase("CauseOfDeathTrends") ) {

	DSchart1.initializeDiagnosisStatistics(dsBean, view);
