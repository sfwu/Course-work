<div class="panel panel-default">
	...
	<div class="panel-body" id="edit-menu">
...
<div class="panel panel-default">
	<div class="panel-heading" anim-type="collapse" anim-target="#wellness-menu">
		<h2 class="panel-title">My Wellness Diary</h2>
	</div>
	<div class="panel-body" id="wellness-menu">
		<ul class="nav nav-sidebar">
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="view-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/patient/viewAccessLog.jsp">Access Log</a>
			<li><a href="/iTrust/auth/patient/calendar.jsp">Full Calendar</a>
			<li><a href="/iTrust/auth/patient/myDiagnoses.jsp">My Diagnoses</a>
		    <li><a href="/iTrust/auth/patient/viewMyLabProcedures.jsp">My Lab Procedures</a>
			<li><a href="/iTrust/auth/patient/viewVisitedHCPs.jsp">My Providers</a>
		    <li><a href="/iTrust/auth/patient/viewPatientInstructions.jsp">Patient Specific Instructions</a>
			<li><a href="/iTrust/auth/patient/viewExpiredPrescriptionRecords.jsp">My Expired Prescription Reports</a>
			<li><a href="/iTrust/auth/patient/viewMyImmunizations.jsp">Immunization Report</a>
...
<div class="panel panel-default">
	<div class="panel-heading" anim-type="collapse" anim-target="#records-menu">
		<h2 class="panel-title">Records</h2>
	</div>
	<div class="panel-body" id="records-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/patient/viewMyRecords.jsp">View My Records</a>
			<li><a href="/iTrust/auth/patient/viewPrescriptionRecords.jsp">Prescription Records</a>
			<li><a href="/iTrust/auth/patient/requestRecordsReleaseHistory.jsp">Request Records Release</a>
		</ul>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="tele-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/patient/addTelemedicineData.jsp">Report Telemedicine Status</a>
		</ul>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="oph-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/patient/ophthalmologyHome.jsp">Ophthalmology Home</a></li>
			<li><a href="/iTrust/auth/patient/addOphthalmologyOVRequest.jsp">Add Ophthalmology Office Visit Request</a></li>
			<li><a href="/iTrust/auth/patient/viewOphthalmologyScheduleOV.jsp">View Scheduled Ophthalmology Office Visits</a></li>
			<li><a href="/iTrust/auth/patient/ophthalmologyHome.jsp?view">View Ophthalmology Records</a></li>
			<li><a href="/iTrust/auth/patient/ophthalmologyHome.jsp?viewDependent">View Dependent's Ophthalmology Records</a></li>
		</ul>
	</div>
</div>
