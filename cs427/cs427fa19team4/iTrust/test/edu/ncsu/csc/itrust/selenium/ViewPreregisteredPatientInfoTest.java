...
public class ViewPreregisteredPatientInfoTest extends iTrustSeleniumTest {
    ...
    public void testMandatoryData() throws Exception{
        ...
        assertEquals(true, driver.getPageSource().contains("72"));
        assertEquals(true, driver.getPageSource().contains("300"));
        assertEquals(true, driver.getPageSource().contains("every day"));
    }
}
