...
public class ViewDiagnosisStatisticsTest extends iTrustSeleniumTest {
	...
	/*
	 * This is the part we test our UC20
	 * MID 9000000000
	 * Password: pw
	 * Choose "Diagnosis Trends"
	 * Select "Cause-of-Death trends"
	 * Enter Fields:
	 * 
	 * StartDate: 09/28/2010, EndDate: 09/28/2011
	 * Gender: all patient
	 * 
	 * It throws exception beacause of the worng info
	*/
	@Test
	public void testViewDiagnosisTrends_COD_WrongDateStartEnd() throws Exception {
	 ...
	 * This is the part we test our UC20
	 * 
	 * (1) we test the case when we select all patient
	 * MID 9000000000
	 * Password: pw
	 * Choose "Diagnosis Trends"
	 * Select "Cause-of-Death trends"
	 * Enter Fields:
	 * 
	 * StartDate: 08/01/2002, EndDate: 09/28/2011
	 * Gender: all patient
	 * 
	 * It throws exception beacause of the worng info
	*/
	@Test
	public void testViewDiagnosisTrends_COD_All() throws Exception {
		driver = (HtmlUnitDriver)login("9000000000", "pw");
		...
		//feed start date and end date
		driver.findElement(By.name("startDate")).clear();
		driver.findElement(By.name("startDate")).sendKeys("08/01/2002");
		...
		WebElement top1 = elem.findElements(By.tagName("td")).get(0);
		assertTrue(top1.getText().contains("250.10 (1)"));
		WebElement top2 = elem.findElements(By.tagName("td")).get(1);
		assertTrue(top2.getText().contains("NONE"));	
	}

	/*
	 * This is the part we test our UC20
	 * 
	 * (1) we test the case when we select male
	 * MID 9000000000
	 * Password: pw
	 * Choose "Diagnosis Trends"
	 * Select "Cause-of-Death trends"
	...
	*/
	@Test
	public void testViewDiagnosisTrends_COD_Male() throws Exception {
		driver = (HtmlUnitDriver)login("9000000000", "pw");
	 ...
	 * This is the part we test our UC20
	 * 
	 * (1) we test the case when we select female
	 * MID 9000000000
	 * Password: pw
	 * Choose "Diagnosis Trends"
	 * Select "Cause-of-Death trends"
	...
	*/
	@Test
	public void testViewDiagnosisTrends_COD_Female() throws Exception {
		driver = (HtmlUnitDriver)login("9000000000", "pw");
		...
		//assertTrue(isElementPresent(By.id("diagnosisStatisticsTable")));
		WebElement top1 = elem.findElements(By.tagName("td")).get(0);
		assertTrue(top1.getText().contains("NONE"));
		WebElement top2 = elem.findElements(By.tagName("td")).get(1);
		assertTrue(top2.getText().contains("NONE"));	
	}
