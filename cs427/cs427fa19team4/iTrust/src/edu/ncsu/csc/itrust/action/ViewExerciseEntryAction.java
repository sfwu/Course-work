...
public class ViewExerciseEntryAction implements ViewEntryAction {
	 ...
	 */
	private boolean isViewAllowed(long patientMID) throws ITrustException {
		PersonnelBean personnel;
		try {

			return (patientDAO.checkPatientExists(loggedInMID) && loggedInMID == patientMID)
