...
%>
	...
	<select name="viewSelect" style="font-size:10" >
		...
		<option value="CauseOfDeathTrends"> Cause-of-Death Trends </option>
	</select>
...
<%
} else if(view.equalsIgnoreCase("CauseOfDeathTrends")){
%>
	<form action="viewDiagnosisStatistics.jsp" method="post" id="formSelectFlow">
	<select name="viewSelect" style="font-size:10" >
		<option value="trends"> Trends </option>
		<option value="epidemics"> Epidemics </option>
		<option selected="selected" value="CauseOfDeathTrends"> Cause-of-Death Trends </option>
	</select>
	<input type="submit" id="select_View" value="Go">
</form>
	<%@include file="viewCauseOfDeathTrends.jsp" %>
<%
	}
} else {
%>
