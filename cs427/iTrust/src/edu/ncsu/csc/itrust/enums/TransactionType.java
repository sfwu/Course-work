...
public enum TransactionType {
	...
	/**PREREGISTER_PATIENT**/
	CREATE_PREREGISTERED(104,  "User preregistered as a patient", "preregister your account", false),
	/**ACTIVATE_PREREGISTERED**/
	ACTIVATE_PREREGISTERED(105, "Activate preregistered patient", "activate preregistered patient", true),
	/**DEACTIVATE_PREREGISTERED**/
	DEACTIVATE_PREREGISTERED(106, "Deactivate preregistered patient", "Deactivate preregistered patient", true),
	/**LHCP_CREATE*/
    ...
    SEND_APPOINTMENT_REMINDERS(2275, "Send Appointment Reminders", "sent all appointment reminders", true),
    ...
    /**REMINDER_OUTBOX_VIEW*/
    REMINDER_OUTBOX_VIEW(3012, "View reminders outbox", "viewed reminders outbox", false),
	/**REMINDER_INBOX_VIEW*/
	REMINDER_INBOX_VIEW(3013, "View reminders inbox", "viewed reminders inbox", true),
