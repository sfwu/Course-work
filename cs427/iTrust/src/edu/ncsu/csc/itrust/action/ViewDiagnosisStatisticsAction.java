...
public class ViewDiagnosisStatisticsAction {
	...
	public DiagnosisStatisticsBean getCauseOfDeath(String lowerDate, String upperDate, String gender) throws FormValidationException, ITrustException {
		DiagnosisStatisticsBean dsBean;
		try {
			...
			dsBean = diagnosesDAO.getDeathStatistics(lower, upper, gender);
