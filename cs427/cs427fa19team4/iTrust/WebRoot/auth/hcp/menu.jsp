<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp-uap/viewPreregisteredPatients.jsp">View Pre-registered</a>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="appt-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/sendApptReminders.jsp">Send Appointment Reminders</a>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="msg-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/reminderMessageOutbox.jsp">Reminder Message Outbox</a>
