...
public class ViewMyMessagesActionTest extends TestCase {
	...
	public void testGetAllMySentReminders() throws DBException, ITrustException, SQLException {
		assertEquals(6, action2.getAllMySentReminders().size());
	}
	public void testGetAllMyReminders() throws DBException, ITrustException, SQLException {
		assertEquals(4, action.getAllMyReminders().size());
	}
	/**
