...
public class PreregisterActivatedPatientTest extends iTrustSeleniumTest{
    ...
    public void testMandatoryData() throws Exception{
        ...
        assertEquals(true, driver.getPageSource().contains("Activate"));
        driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/table/tbody/tr/td[3]/form/input[2]")).click();
        assertEquals(true, driver.getPageSource().contains("Deactivate"));
        driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/table/tbody/tr/td[3]/form/input[2]")).click();
        assertEquals(false, driver.getPageSource().contains("Krastan Dimitrov"));
    }
}
