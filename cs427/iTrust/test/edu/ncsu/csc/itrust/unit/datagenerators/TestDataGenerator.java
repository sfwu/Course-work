...
public class TestDataGenerator {
	...
	public void apptReminderCase1() throws SQLException, FileNotFoundException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/apptRemindersCase1.sql");
	}
	...
	public void preregisteredStandard() throws FileNotFoundException, IOException,
			SQLException {
		standardData();
		new DBBuilder(factory).executeSQLFile(DIR + "/preregistered.sql");
	...
	public void uc41SetUp() throws FileNotFoundException, SQLException,
	IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc41SetUp.sql");
	}
