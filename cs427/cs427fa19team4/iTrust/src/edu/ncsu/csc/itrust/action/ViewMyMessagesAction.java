...
public class ViewMyMessagesAction {
	...
	public ViewMyMessagesAction(DAOFactory factory, long loggedInMID) {
		...
		this.fakeEmailDAO = factory.getFakeEmailDAO();
	}
	...
	public List<Email> getAllMySentReminders() throws DBException, SQLException, ITrustException {
		return fakeEmailDAO.getReminderByDoctor(getName(loggedInMID));
	}

	public List<Email> getAllMyReminders() throws DBException, SQLException, ITrustException {
		return fakeEmailDAO.getEmailsByPerson(getName(loggedInMID));
	}
