...
public class AppointmentTest extends iTrustSeleniumTest{
	...
	protected void setUp() throws Exception {
		...
		gen.clearAllTables();
		gen.standardData();
		gen.apptReminderCase1();
	}
	public void testSendApptReminders() throws Exception {
		WebDriver driver = login("9000000000", "pw");
		assertLogged(TransactionType.HOME_VIEW, 9000000000L, 0L, "");
		WebElement element;
		element = driver.findElement(By.linkText("Send Appointment Reminders"));
		element.click();

		element = driver.findElement(By.name("days"));
		element.sendKeys("20");

		element = driver.findElement(By.id("sendReminders"));
		element.submit();
		...
		driver.findElement(By.xpath("//a[@href='viewReminderMessageInbox.jsp?msg=1']")).click();
